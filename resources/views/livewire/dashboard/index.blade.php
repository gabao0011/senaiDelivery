    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card bg-white shadow-sm border-0 h-100">
                <div class="card-body">
                    <p clas="text-secondary m-1"> Total de administradores</p>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card bg-white shadow-sm border-0 h-100">
                <div class="card-body">
                    <p clas="text-secondary m-1"> Total de Clientes</p>
                    <h2 class="h3 mb-0">{{ $totalClientes }}</h2>
                </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card bg-white shadow-sm border-0 h-100">
                <div class="card-body">
                    <p clas="text-secondary m-1"> Total de Categorias</p>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card bg-white shadow-sm border-0 h-100">
                <div class="card-body">
                    <p clas="text-secondary m-1"> Total de Produtos</p>
